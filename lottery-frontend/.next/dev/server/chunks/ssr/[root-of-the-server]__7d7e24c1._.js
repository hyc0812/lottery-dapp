...
(()=>{
    const e = new Error("Cannot find module 'wagmi/transports'");
...
const customChain = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$viem__$5b$external$5d$__$28$viem$2c$__esm_import$29$__["defineChain"])({
    id: chainId,
    name: chainId === 11155111 ? 'Sepolia' : 'CustomChain',
    nativeCurrency: {
        name: 'Ether',
        symbol: 'ETH',
        decimals: 18
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7d7e24c1._.js.map