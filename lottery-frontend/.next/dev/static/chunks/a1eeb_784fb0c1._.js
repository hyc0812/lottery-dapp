...
"[project]/Downloads/lottery-frontend/node_modules/@wagmi/core/dist/esm/connectors/mock.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f40$wagmi$2f$core$2f$dist$2f$esm$2f$connectors$2f$createConnector$2e$js__$5b$client$5d$__$28$ecmascript$29$__["createConnector"])((config)=>({
            ...
            async connect ({ chainId, withCapabilities } = {}) {
                if (features.connectError) {
                    if (typeof features.connectError === 'boolean') throw new __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$viem$2f$_esm$2f$errors$2f$rpc$2e$js__$5b$client$5d$__$28$ecmascript$29$__["UserRejectedRequestError"](new Error('Failed to connect.'));
                ...
                return {
                    accounts: withCapabilities ? accounts.map((x)=>({
                            address: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$address$2f$getAddress$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getAddress"])(x),
                            capabilities: {
                                foo: {
                                    bar: x
                                }
                            }
                        })) : accounts.map((x)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$address$2f$getAddress$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getAddress"])(x)),
                    chainId: currentChainId
                };
            },
            async disconnect () {
            ...
            async getAccounts () {
                if (!connected) throw new __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f40$wagmi$2f$core$2f$dist$2f$esm$2f$errors$2f$config$2e$js__$5b$client$5d$__$28$ecmascript$29$__["ConnectorNotConnectedError"]();
                const provider = await this.getProvider();
                const accounts = await provider.request({
                    method: 'eth_accounts'
                });
            ...
            async getChainId () {
                ...
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$encoding$2f$fromHex$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fromHex"])(hexChainId, 'number');
            },
            async isAuthorized () {
            ...
            async getProvider ({ chainId } = {}) {
                ...
                const request = async ({ method, params })=>{
                    // eth methods
                    if (method === 'eth_chainId') return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$encoding$2f$toHex$2e$js__$5b$client$5d$__$28$ecmascript$29$__["numberToHex"])(connectedChainId);
                    if (method === 'eth_requestAccounts') return parameters.accounts;
                    if (method === 'eth_signTypedData_v4') {
                        if (features.signTypedDataError) {
                            if (typeof features.signTypedDataError === 'boolean') throw new __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$viem$2f$_esm$2f$errors$2f$rpc$2e$js__$5b$client$5d$__$28$ecmascript$29$__["UserRejectedRequestError"](new Error('Failed to sign typed data.'));
                    ...
                    if (method === 'wallet_switchEthereumChain') {
                        if (features.switchChainError) {
                            if (typeof features.switchChainError === 'boolean') throw new __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$viem$2f$_esm$2f$errors$2f$rpc$2e$js__$5b$client$5d$__$28$ecmascript$29$__["UserRejectedRequestError"](new Error('Failed to switch chain.'));
                            throw features.switchChainError;
                        }
                        connectedChainId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$encoding$2f$fromHex$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fromHex"])(params[0].chainId, 'number');
                        this.onChainChanged(connectedChainId.toString());
                        return;
                    }
                    if (method === 'wallet_watchAsset') {
                        if (features.watchAssetError) {
                            if (typeof features.watchAssetError === 'boolean') throw new __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$viem$2f$_esm$2f$errors$2f$rpc$2e$js__$5b$client$5d$__$28$ecmascript$29$__["UserRejectedRequestError"](new Error('Failed to switch chain.'));
                    ...
                    if (method === 'wallet_sendCalls') {
                        ...
                        for (const call of calls){
                            const { result, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$rpc$2f$compat$2e$js__$5b$client$5d$__$28$ecmascript$29$__["rpc"].http(url, {
                                body: {
                    ...
                    if (method === 'personal_sign') {
                        if (features.signMessageError) {
                            if (typeof features.signMessageError === 'boolean') throw new __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$viem$2f$_esm$2f$errors$2f$rpc$2e$js__$5b$client$5d$__$28$ecmascript$29$__["UserRejectedRequestError"](new Error('Failed to sign message.'));
                    ...
                    const { error, result } = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$rpc$2f$compat$2e$js__$5b$client$5d$__$28$ecmascript$29$__["rpc"].http(url, {
                        body
                    });
                    if (error) throw new __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$viem$2f$_esm$2f$errors$2f$request$2e$js__$5b$client$5d$__$28$ecmascript$29$__["RpcRequestError"]({
                        body,
                ...
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$viem$2f$_esm$2f$clients$2f$transports$2f$custom$2e$js__$5b$client$5d$__$28$ecmascript$29$__["custom"])({
                    request
                })({
                    retryCount: 0
                });
...
"[project]/Downloads/lottery-frontend/node_modules/@wagmi/core/dist/esm/utils/extractRpcUrls.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Downloads/lottery-frontend/node_modules/wagmi/dist/esm/exports/connectors.js [client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/Downloads/lottery-frontend/node_modules/wagmi/dist/esm/exports/connectors.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "baseAccount",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f40$wagmi$2f$connectors$2f$dist$2f$esm$2f$exports$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["baseAccount"],
    "coinbaseWallet",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f40$wagmi$2f$connectors$2f$dist$2f$esm$2f$exports$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["coinbaseWallet"],
    "gemini",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f40$wagmi$2f$connectors$2f$dist$2f$esm$2f$exports$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["gemini"],
    "injected",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f40$wagmi$2f$connectors$2f$dist$2f$esm$2f$exports$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["injected"],
    "metaMask",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f40$wagmi$2f$connectors$2f$dist$2f$esm$2f$exports$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["metaMask"],
    "mock",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f40$wagmi$2f$connectors$2f$dist$2f$esm$2f$exports$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["mock"],
    "porto",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f40$wagmi$2f$connectors$2f$dist$2f$esm$2f$exports$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["porto"],
    "safe",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f40$wagmi$2f$connectors$2f$dist$2f$esm$2f$exports$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["safe"],
    "version",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f40$wagmi$2f$connectors$2f$dist$2f$esm$2f$exports$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["version"],
    "walletConnect",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f40$wagmi$2f$connectors$2f$dist$2f$esm$2f$exports$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["walletConnect"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$wagmi$2f$dist$2f$esm$2f$exports$2f$connectors$2e$js__$5b$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/Downloads/lottery-frontend/node_modules/wagmi/dist/esm/exports/connectors.js [client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f40$wagmi$2f$connectors$2f$dist$2f$esm$2f$exports$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/lottery-frontend/node_modules/@wagmi/connectors/dist/esm/exports/index.js [client] (ecmascript)");
}),
...
"[project]/Downloads/lottery-frontend/node_modules/viem/_esm/utils/rpc/socket.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        fn: async ()=>{
            ...
            async function setup() {
                const result = await getSocket({
                    onClose () {
                        ...
                        for (const request of requests.values())request.onError?.(new __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$viem$2f$_esm$2f$errors$2f$request$2e$js__$5b$client$5d$__$28$ecmascript$29$__["SocketClosedError"]({
                            url
                        }));
                        for (const subscription of subscriptions.values())subscription.onError?.(new __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$viem$2f$_esm$2f$errors$2f$request$2e$js__$5b$client$5d$__$28$ecmascript$29$__["SocketClosedError"]({
                            url
                        }));
                        attemptReconnect();
                    },
            ...
            socketClient = {
                ...
                request ({ body, onError, onResponse }) {
                    ...
                    const id = body.id ?? __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$rpc$2f$id$2e$js__$5b$client$5d$__$28$ecmascript$29$__["idCache"].take();
                ...
                requestAsync ({ body, timeout = 10_000 }) {
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$promise$2f$withTimeout$2e$js__$5b$client$5d$__$28$ecmascript$29$__["withTimeout"])(()=>new Promise((onResponse, onError)=>this.request({
                                body,
                                onError,
                                onResponse
                            })), {
...
"[project]/Downloads/lottery-frontend/node_modules/viem/_esm/utils/rpc/webSocket.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$viem$2f$_esm$2f$errors$2f$request$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/lottery-frontend/node_modules/viem/_esm/errors/request.js [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$rpc$2f$socket$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/lottery-frontend/node_modules/viem/_esm/utils/rpc/socket.js [client] (ecmascript)");
;
;
async function getWebSocketRpcClient(url, options = {}) {
    const { keepAlive, reconnect } = options;
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$rpc$2f$socket$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getSocketRpcClient"])({
        async getSocket ({ onClose, onError, onOpen, onResponse }) {
            const WebSocket = await __turbopack_context__.A("[project]/Downloads/lottery-frontend/node_modules/isows/_esm/native.js [client] (ecmascript, async loader)").then((module)=>module.WebSocket);
            ...
            return Object.assign(socket, {
                ...
                ping () {
                    try {
                        if (socket.readyState === socket.CLOSED || socket.readyState === socket.CLOSING) throw new __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$viem$2f$_esm$2f$errors$2f$request$2e$js__$5b$client$5d$__$28$ecmascript$29$__["WebSocketRequestError"]({
                            url: socket.url,
                            cause: new __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$viem$2f$_esm$2f$errors$2f$request$2e$js__$5b$client$5d$__$28$ecmascript$29$__["SocketClosedError"]({
                                url: socket.url
                            })
                        });
                        const body = {
...
"[project]/Downloads/lottery-frontend/node_modules/viem/_esm/utils/rpc/compat.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getSocket(url) {
    const client = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$rpc$2f$webSocket$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getWebSocketRpcClient"])(url);
...
const rpc = {
     ...
     * ```
     */ http (url, params) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$lottery$2d$frontend$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$rpc$2f$http$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getHttpRpcClient"])(url).request(params);
    },
    /**
...
//# sourceMappingURL=a1eeb_784fb0c1._.js.map